...
TEST(fedorets_i_simpson_tbb, Func_1) {
  // Create data
  ...
  // Create Task
  fedorets_i_simpson_tbb::SimpsonSequential taskSequential(taskDataSeq);
  ...
  // Create Task
  fedorets_i_simpson_tbb::SimpsonParallel taskParallel(taskDataParallel);
...
TEST(fedorets_i_simpson_tbb, Func_2) {
  // Create data
  std::vector<double> out(1, 0);
...
TEST(fedorets_i_simpson_tbb, Func_3) {
  // Create data
  std::vector<double> out(1, 0);
...
TEST(fedorets_i_simpson_tbb, Func_4) {
  // Create data
  std::vector<double> out(1, 0);
...
TEST(fedorets_i_simpson_tbb, Func_5) {
  // Create data
  std::vector<double> out(1, 0);
